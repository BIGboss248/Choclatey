...
# === EDIT HERE ===
$packageRepo = 'http://192.168.0.143:8081/repository/Chocolatey-Group/'
...
$unzipMethod = 'builtin'
#$unzipMethod = '7zip'
#$7zipUrl = 'C:\choco-setup\packages\7zip.install.22.1.nupkg' (download this file, host internally, and update this to internal)
...
$localChocolateyPackageFilePath = 'c:\choco-setup\packages\chocolatey.0.10.8.nupkg'
